...
class URLSessionHTTPClientTests: XCTestCase {
    ...
    func test_getFromURL_failsOnRequestError() {
        ...
        let errorToCompare = (recievedError as? NSError)!
        XCTAssertEqual(errorToCompare.domain, requestError.domain)
        XCTAssertEqual(errorToCompare.code, requestError.code)
    }
